Warning: truncated output (original token count: 41207)
...
(() => {
  ...
  Object.assign(dict.uk, {
    ...
    trustWarrantyText: "Апаратна гарантія — від 3 до 12 місяців для товарів із гарантією. Точний строк зазначений у картці конкретного товару; відлік починається з дня отримання покупцем.\nГарантія покриває апаратні несправності, не спричинені покупцем. Зарядний пристрій, якщо він входить до комплекту, також покривається гарантією. Комплектність зазначена в описі: зарядний пристрій, лише кабель або без зарядного пристрою.\nНе покриваються несправності, спричинені падінням, залиттям, механічним пошкодженням або неналежним використанням, а також природне зношення акумулятора. Використання власної зарядки саме собою не скасовує гарантію. Відмова можлива, якщо діагностика встановить, що несправність спричинила несумісна або несправна зарядка.\nДля звернення напишіть у Telegram @HUGO_Media або зателефонуйте за вказаним контактним номером. Повідомте модель, дату отримання та опишіть несправність. Передати пристрій можна особисто у Варшаві або поштою за погодженою адресою.\nДіагностика та виконання гарантійного зобов’язання — протягом 14 календарних днів після отримання нами пристрою. Результат діагностики та причину можливої відмови повідомляємо покупцю. Доставка в межах гарантійного обслуговування — за рахунок гаранта. Для пошкодження з вини покупця витрати на пересилання погоджуємо окремо до їх виникнення.\nЦя добровільна гарантія не обмежує законних прав покупця щодо невідповідності товару договору та засобів захисту за рахунок продавця.",
    trustPayment: "Оплата",
    ...
    trustReturnsText: "Гарантійний випадок: пропонуємо заміну, іншу модель за погодженням із покупцем або повернення сплаченої суми. Якщо ціна альтернативної моделі відрізняється, доплату або повернення різниці погоджуємо окремо. Діагностика й виконання зобов’язання разом займають до 14 календарних днів від отримання нами пристрою.\nЗаконні права споживача діють незалежно від добровільної гарантії. При розірванні договору через невідповідність товару договору за передбачених законом підстав продавець повертає ціну без зволікання, не пізніше 14 днів від отримання товару або підтвердження його відправлення.\nДля дистанційного договору між підприємцем і споживачем, за відсутності законного винятку, покупець може заявити про відмову без пояснення причин протягом 14 днів від отримання товару. Товар потрібно відправити назад протягом 14 днів від заяви. Оплату, включно з вартістю найдешевшої стандартної доставки, повертають протягом 14 днів від отримання заяви, тим самим способом, якщо інше не погоджено без додаткових витрат. Якщо продавець не запропонував забрати товар самостійно, він може затримати повернення до отримання товару або доказу відправлення — залежно від того, що станеться раніше.\nЩоб погодити передачу пристрою та отримати адресу, зверніться в Telegram @HUGO_Media. Цей опис не обмежує обов’язкових прав покупця.",
  ...
  Object.assign(dict.pl, {
    ...
    trustWarrantyText: "Gwarancja na sprzęt wynosi od 3 do 12 miesięcy dla produktów objętych gwarancją. Dokładny okres jest podany w karcie produktu i liczony od dnia otrzymania go przez kupującego.\nGwarancja obejmuje usterki sprzętowe niezawinione przez kupującego. Ładowarka dołączona do zestawu również jest objęta gwarancją. Wyposażenie wskazujemy w opisie: ładowarka, sam kabel lub brak ładowarki.\nGwarancja nie obejmuje usterek spowodowanych upadkiem, zalaniem, uszkodzeniem mechanicznym lub niewłaściwym użytkowaniem ani naturalnego zużycia akumulatora. Samo używanie własnej ładowarki nie powoduje utraty gwarancji. Odmowa jest możliwa, jeśli diagnostyka wykaże, że usterkę spowodowała niekompatybilna lub niesprawna ładowarka.\nZgłoszenia przyjmujemy przez Telegram @HUGO_Media lub pod podanym numerem kontaktowym. Podaj model, datę otrzymania i opis usterki. Sprzęt można przekazać osobiście w Warszawie lub wysłać na uzgodniony adres.\nDiagnostykę i wykonanie zobowiązania gwarancyjnego realizujemy w ciągu 14 dni kalendarzowych od otrzymania sprzętu. Informujemy kupującego o wyniku diagnostyki i przyczynie ewentualnej odmowy. Dostawa w ramach obsługi gwarancyjnej odbywa się na koszt gwaranta. Przy uszkodzeniu z winy kupującego koszty przesyłek uzgadniamy osobno, zanim zostaną poniesione.\nGwarancja nie ogranicza ustawowych środków ochrony prawnej przysługujących kupującemu ze strony i na koszt sprzedawcy w przypadku niezgodności towaru z umową.",
    ...
    trustReturnsText: "W przypadku objętym gwarancją proponujemy wymianę, inny model uzgodniony z kupującym lub zwrot zapłaconej kwoty. Jeżeli cena alternatywnego modelu jest inna, dopłatę lub zwrot różnicy uzgadniamy osobno. Diagnostyka i wykonanie zobowiązania łącznie trwają do 14 dni kalendarzowych od otrzymania sprzętu.\nUstawowe prawa konsumenta są niezależne od dobrowolnej gwarancji. Przy odstąpieniu od umowy z powodu niezgodności towaru z umową, gdy zachodzą ustawowe przesłanki, sprzedawca zwraca cenę niezwłocznie, nie później niż w ciągu 14 dni od otrzymania towaru lub dowodu jego odesłania.\nPrzy umowie zawartej na odległość między przedsiębiorcą a konsumentem, jeśli nie zachodzi ustawowy wyjątek, kupujący może odstąpić bez podania przyczyny w ciągu 14 dni od otrzymania towaru. Towar należy odesłać w ciągu 14 dni od odstąpienia. Zwrot płatności, w tym kosztu najtańszej standardowej dostawy, następuje w ciągu 14 dni od otrzymania oświadczenia, tą samą metodą, chyba że uzgodniono inną bez dodatkowych kosztów. Jeżeli sprzedawca nie zaproponował odbioru towaru, może wstrzymać zwrot do otrzymania towaru lub dowodu odesłania — zależnie od tego, co nastąpi wcześniej.\nAby uzgodnić przekazanie sprzętu i otrzymać adres, skontaktuj się przez Telegram @HUGO_Media. Ten opis nie ogranicza obowiązkowych praw kupującego.",
  ...
  function recordEvent(event_type, product_id = null, destination = "", placement = "") {
    ...
    return db.trackEvent({
      ...
      language: lang,
      destination: String(destination…11207 tokens truncated…   if (benefits.includes("keyboard")) highlights.push(t("benefitKeyboard"));
    ...
    if (view === "detail") {
      ...
      const specs = [
        ...
        similar = products
          ...
          .slice(0, 3);
      const introText = description.replace(/\s+/g, ' ').trim();
      const intro = introText.length > 190 ? introText.slice(0,190).replace(/\s+\S*$/, '') + '…' : introText;
      const productDescription = description ? `<section class="hm-product-description"><p class="hm-description-intro">${esc(intro)}</p>${introText.length>190?`<details id="hm-full-description"><summary>${lang==='uk'?'Повний опис':'Pełny opis'}</summary><p class="hp-description">${esc(description)}</p></details>`:''}</section>` : '';

      content.innerHTML = `<div class="hp-detail-page"><button type="button" class="hp-back hp-detail-back" data-view="catalog">${icon("arrow-left")}${t("back")}</button>
<section class="hp-detail-hero hm-compact-detail" data-detail-product="${p.id}"><header class="hm-detail-heading"><div class="hp-kicker">${esc(p.brand)} · ${t("verifiedLabel")}</div><h1>${esc(productTitle(p))}</h1><p class="hp-detail-config">${esc(storefront.specSummary(p))}</p></header><div class="hm-detail-media"><div class="hp-gallery-panel"><div class="hp-gallery-head"><span>${icon("camera")}${p.photoKind === "actual" ? t("productPhoto") : p.photoKind === "model" ? (lang === "uk" ? "Ілюстрація моделі" : "Zdjęcie modelu") : (lang === "uk" ? "Зображення товару" : "Zdjęcia produktu")}</span><span>HMG-${p.id.toString().padStart(3, "0")}</span></div>${photo(p)}${p.images.length > 1 ? `<div class="hp-toprow hp-thumbs">${p.images.map((src, i) => `<button type="button" class="hp-button" data-image="${i}"><img src="${esc(pictureUrl(src))}" alt="${i + 1}"></button>`).join("")}</div>` : ""}</div><section class="hm-product-review"><a class="hp-button hp-channel-button" href="${esc(telegramPostUrl(p.telegramPost))}" target="_blank" rel="noopener noreferrer">${icon('play-circle')}<span>${lang==='uk'?'Фото та відеоогляд у Telegram':'Zdjęcia i prezentacja w Telegramie'}</span>${icon('arrow-up-right')}</a></section><section id="hm-full-specs" class="hp-detail-info-card hm-spec-details" aria-labelledby="hm-specs-title"><h2 id="hm-specs-title">${t('specTitle')}</h2><div class="hp-detailspec">${specs.map(([k,v])=>`<div><span>${esc(k)}</span><b>${esc(v)}</b></div>`).join('')}</div></section></div><div class="hm-product-overview"><div class="hp-detail-badges"><span class="hp-demo-status">${t("statuses")[p.status]}</span>${p.newArrival === "true" ? `<span class="hp-badge-new">${t("newArrival")}</span>` : ""}${p.bestseller === "true" ? `<span class="hp-badge-best">${t("bestseller")}</span>` : ""}${discountPercent(p) ? `<span class="hp-badge-sale">-${discountPercent(p)}%</span>` : ""}</div><div class="hp-stock ${qty === 1 ? "hp-stock-low" : ""}">${qty === 1 ? t("onlyOne") : `${qty} ${t("unitsLeft")}`}</div>${priceBlock(p, true)}<div class="hm-buy-facts">${p.condition ? `<span><small>${t("conditionShort")}</small><b>${esc(localizedValue(p.condition))}</b></span>` : ""}${p.warranty ? `<span><small>${t("warrantyShort")}</small><b>${esc(localizedValue(p.warranty))}</b></span>` : ""}</div>${purposeCodes.length ? `<div class="hp-purpose-tags">${purposeCodes.map((code) => `<span>${t(purposeKey(code))}</span>`).join("")}</div>` : ""}${productDescription}${benefitCodes.length ? `<div class="hp-benefit-list">${benefitCodes.map(code=>`<span>${icon('check-circle-2')}${t(benefitKey(code))}</span>`).join('')}</div>`:''}</div>


<section id="hm-product-checkout" class="hm-product-checkout hp-buy-panel" tabindex="-1"><div class="hm-checkout-heading"><h2>${lang==='uk'?'Конфігуратор та замовлення':'Konfigurator i zamówienie'}</h2></div>
${configPanel(p,bundleSelections[p.id],upgradeSelections[p.id],lang,esc,money)||`<div class="hm-checkout-base"><span>${lang==='uk'?'Вартість товару':'Cena produktu'}</span><strong>${money(selectedConfig(p).total)} zł</strong></div>`}
<div class="hm-checkout-actions"><div class="hp-detail-actions hp-detail-primary-actions"><button type="button" class="hp-button hp-primary" data-order-one="${p.id}" ${p.status !== 0 || qty < 1 ? "disabled" : ""}>${icon("send")}${lang === "uk" ? "Замовити в Telegram" : "Zamów w Telegramie"}</button></div><div class="hp-detail-secondary-actions"><button type="button" class="hp-button hp-choice-button" data-add="${p.id}" ${p.status !== 0 || qty < 1 ? "disabled" : ""}>${icon(cart.includes(p.id) ? "check" : "shopping-bag")}${cart.includes(p.id) ? t("added") : t("add")}</button><button type="button" class="hp-button" data-compare="${p.id}">${icon(compare.includes(p.id) ? "check" : "columns-2")}${t("compare")}</button><button type="button" class="hp-button" id="hp-share" aria-label="${t("share")}">${icon("share-2")}</button></div><p class="hp-muted hp-small">${lang==='uk'?'Комплектація й сума потраплять у повідомлення Telegram.':'Konfiguracja i suma trafią do wiadomości w Telegramie.'}</p></div></section></section>${reviewsBlock(3)}${similar.length ? `<section class="hp-home-section hp-similar-section"><div class="hp-section-title"><h2>${t("similar")}</h2></div><div class="hp-grid">${similar.map(productCard).join("")}</div></section>` : ""}</div>`;
      ...
      content.insertAdjacentHTML("beforeend", `<div class="hp-mobile-order-bar"><div><small>${esc(productTitle(p))}</small><strong>${money(selectedConfig(p).total)} zł</strong></div><button type="button" class="hp-button hp-primary" data-jump-config>${lang==='uk'?'До комплектації':'Konfiguracja'}</button><a href="${esc(telegramPostUrl(p.telegramPost))}" target="_blank" rel="noopener noreferrer" data-track-target="${p.telegramPost ? "telegram_product" : "telegram_channel"}" data-track-placement="product" aria-label="${t("telegramMedia")}">${icon("send")}<span>Telegram</span></a></div>`);
    }
    if (view === "compare") {
    ...
    extra.afterRender();
    for(const [id,open] of detailOpen){const el=document.getElementById(id);if(el)el.open=open;}
    refreshIcons();
    renderCompareDock();
  }
  ...
  root.addEventListener("click", async (e) => {
    if(e.target.closest('[data-jump-config]')){const panel=q('#hm-product-checkout');panel?.scrollIntoView({behavior:matchMedia('(prefers-reduced-motion: reduce)').matches?'auto':'smooth',block:'start'});panel?.focus({preventScroll:true});return;}
  ...
  root.addEventListener("change", async (e) => {
    ...
    if (el.matches("input[data-pick]")) {
      ...
      render();q(`[data-bundle="${el.dataset.bundle}"]`)?.focus({preventScroll:true});
