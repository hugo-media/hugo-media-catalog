...
for(const f of ['index.html','styles.css','storefront.css','src/storefront.js','src/configurator.js','src/insights.js','src/insights-core.js','src/app.js','src/core.js','src/data.js','src/enhancements.js','src/enhancement-core.js','src/drafts.js'])await copyFile(f,`dist/${f}`);
